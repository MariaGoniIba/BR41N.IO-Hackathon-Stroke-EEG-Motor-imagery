...
for exp = 1:2:length(experiment)-1
    ...
    righttrain = permute(righttrain,[2, 3, 1]);
    lefttrain = permute(lefttrain,[2, 3, 1]);
    righttest = permute(righttest,[2, 3, 1]);
    lefttest = permute(lefttest,[2, 3, 1]);
    ...
    clear righttrain lefttrain frighttest datatrain datatest ClassesTrain ClassesTest
end
